...
```{r}
file_path = "/Users/jordicatafal/Downloads/ADEI/PROJECTE/heart.csv"
...
```{r}
res.hcpc$desc.var$quanti.var  # Global tests of numerical association
```

```{r}
res.hcpc$desc.var$quanti  # Specific tests of numerical association
```

...
summary(m2)
```
No veiem gaire millora només amb age, així que probem métode stepwise amb els 2 casos.
...
Per a > 45 trobem alguna variable amb més sentit tot i que la majoria segueixen sent contraries als valors lògics.
Upsloping good
flat meh
Downsloping bad

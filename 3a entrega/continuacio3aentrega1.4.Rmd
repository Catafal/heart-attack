...
After seeing the improvement of single interactions, we want to see if the models improves when having two interactions. 
...
We noe try different models adding other interactions with exang.

...
condes(df, 1)
# age & sex -> There is almost nonexistent dependence between these two variables, since p-value < 0.05
# age & cp -> There is almost nonexistent dependence between these two variables, since p-value < 0.05
...
# age & thal ->  There is a almost nonexistent dependence between these two variables, since p-value < 0.05
